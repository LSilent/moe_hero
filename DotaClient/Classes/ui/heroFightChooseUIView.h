#ifndef __HERO_FIGHT_CHOOSE_UI_VIEW_H__
#define __HERO_FIGHT_CHOOSE_UI_VIEW_H__
...
{
public:
	CCB_STATIC_NEW_AUTORELEASE_OBJECT_WITH_INIT_METHOD(HeroFightChooseUIView, create);

public:
	HeroFightChooseUIView();
	virtual ~HeroFightChooseUIView();
...
class HeroFightChooseUIViewLoader : public cocos2d::extension::CCLayerLoader {
public:
	CCB_STATIC_NEW_AUTORELEASE_OBJECT_METHOD(HeroFightChooseUIViewLoader, loader);

protected:
	CCB_VIRTUAL_NEW_AUTORELEASE_CREATECCNODE_METHOD(HeroFightChooseUIView);
};
